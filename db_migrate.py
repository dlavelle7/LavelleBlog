#!flask/bin/python
"""Script to generate a database migration.

A migration is any change to the structure of the database.
"""
...
with open(migration, "wt") as migrate_fie:
    migrate_fie.write(script)
